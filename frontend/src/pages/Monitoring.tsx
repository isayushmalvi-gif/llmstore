  ...
  const fetchStats = useCallback(async () => {
    try {
      const res = await axios.get(
        API_BASE + "/api/v1/monitoring/stats"
      )
      setStats(res.data)
      ...
      <div className="p-8 space-y-6">
        {loading && (
          <div className="flex items-center justify-center h-64">
            <div className="w-10 h-10 border-4 border-gray-800
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="card">
                ...
                <p className={"text-2xl font-bold " +
                  getTextColor(stats.cpu.usage_percent)}>
              ...
              <div className="card">
                ...
                <p className={"text-2xl font-bold " +
                  getTextColor(stats.ram.usage_percent)}>
              ...
              <div className="card">
                ...
                <p className="text-gray-600 text-xs mt-1">
                  {stats.requests.error_rate}% errors
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="card">
                ...
                <div className="h-2 bg-gray-800 rounded-full
                  ...
                  <div className={"h-full rounded-full transition-all " +
                    getUsageColor(stats.cpu.usage_percent)}
              ...
              <div className="card">
                <div className="flex items-center
                                justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 bg-purple-500/20
                                    rounded-lg flex items-center
                                    justify-center">
                      <MemoryStick size={16}
                ...
                <div className="h-2 bg-gray-800 rounded-full
                                mb-4 overflow-hidden">
                  <div className={"h-full rounded-full transition-all " +
                    getUsageColor(stats.ram.usage_percent)}
                    ...
                    <div key={gpu.index} className="card">
                      <div className="flex items-center
                        ...
                        <span className={"text-xl font-bold " +
                          getTextColor(gpu.usage_percent)}>
                          {gpu.usage_percent}%
                        </span>
                      </div>
                      <div className="space-y-3">
                        <div>
                          ...
                          <div className="h-2 bg-gray-800
                            ...
                            <div className={"h-full rounded-full " +
                              getUsageColor(gpu.usage_percent)}
                              style={{
                                width: gpu.usage_percent + "%"
                              }}
                            />
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="h-2 bg-gray-800
                                          rounded-full overflow-hidden">
                            <div className={"h-full rounded-full " +
                              getUsageColor(gpu.vram_percent)}
                              style={{
                                width: gpu.vram_percent + "%"
                              }}
                            />
                          </div>
                        </div>
            ...
            <div className="grid grid-cols-1
              ...
              <div className="card">
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-8 h-8 bg-green-500/20
                                  rounded-lg flex items-center
                                  justify-center">
                    <HardDrive size={16}
                ...
                <div className="space-y-3">
                  ...
                  <div className="h-2 bg-gray-800 rounded-full
                                  overflow-hidden">
                    <div className={"h-full rounded-full " +
                      getUsageColor(stats.disk.usage_percent)}
                      style={{
                        width: stats.disk.usage_percent + "%"
                      }}
                    />
                  </div>
                  <div className="flex justify-between
              ...
              <div className="card">
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-8 h-8 bg-orange-500/20
                                  rounded-lg flex items-center
                                  justify-center">
                    <Activity size={16}
