        ...
        {data && (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <HardwareCard title="CPU" iconBg="bg-blue-500/20"
                icon={<Cpu size={20} className="text-blue-400" />}
                badge={<span className="text-xs text-gray-500 bg-gray-800 px-2 py-1 rounded">{data.cpu.architecture}</span>}>
              ...
              <HardwareCard title="Memory (RAM)" iconBg="bg-purple-500/20"
            ...
            <div>
              ...
              {data.has_gpu ? (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {data.gpus.map((gpu) => (
                    <HardwareCard key={gpu.index} title={`GPU ${gpu.index}: ${gpu.name}`}
                      iconBg="bg-yellow-500/20" icon={<Zap size={20} className="text-yellow-400" />}
                      badge={gpu.cuda_version ? <span className="text-xs bg-green-500/20 text-green-400 px-2 py-1 rounded border border-green-500/30">CUDA {gpu.cuda_version}</span> : undefined}>
                      <div className="space-y-3">
                ...
                <div className="card border-dashed border-gray-700 flex flex-col items-center justify-center py-12 gap-3">
                  ...
                  <p className="text-gray-600 text-sm text-center max-w-sm">
                    GPU is recommended for optimal AI model performance. CPU-only inference available for smaller models.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <HardwareCard title="Storage" iconBg="bg-green-500/20"
              ...
              <HardwareCard title="System Information" iconBg="bg-gray-700"
